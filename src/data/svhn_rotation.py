...
class SVHN_rotation(pl.LightningDataModule):
    ...
    def rotation_func(self, rot):
        return{
              ...
              }.get(rot, lambda: 'Not a valid rotation')()
    ...
    def train_dataloader(self):
        rotation = Rotation(self.train_data, self.rot, "SVHN")
        return DataLoader(rotation, batch_size=self.batch_size, shuffle=True,num_workers=self.num_workers )

    def val_dataloader(self):
        rotation = Rotation(self.valid_data, self.rot, "SVHN")
        return DataLoader(rotation, batch_size=self.batch_size,num_workers=self.num_workers)

    def test_dataloader(self):
        rotation = Rotation(self.test_data, self.rot, "SVHN")
        return DataLoader(rotation, batch_size=self.batch_size,num_workers=self.num_workers)
